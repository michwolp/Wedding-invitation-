...
export const LABELS = {
  en: {
    ...
    '[data-pk=ret-before]': 'Before the after-party<small class="ret-time">around 00:00</small>',
  ...
  ru: {
    ...
    '[data-pk=ret-before]': 'До афтепати<small class="ret-time">около 00:00</small>',
