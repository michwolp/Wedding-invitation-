...
export const LABELS = {
  en: {
    ...
    'label[for=pickup]': 'Coming by shuttle?',
    '#pickup option[value=""]': 'Arriving on our own',
    '#pickup option[value=tlv_after]': 'Shuttle from Tel Aviv — staying for the after-party',
    '#pickup option[value=tlv_noafter]': 'Shuttle from Tel Aviv — leaving before the after-party',
    '#pickup option[value=rhv_after]': 'Shuttle from Rehovot — staying for the after-party',
    '#pickup option[value=rhv_noafter]': 'Shuttle from Rehovot — leaving before the after-party',
  ...
  ru: {
    ...
    'label[for=pickup]': 'Едете на трансфере?',
    '#pickup option[value=""]': 'Добираемся сами',
    '#pickup option[value=tlv_after]': 'Трансфер из Тель-Авива — остаёмся на афтепати',
    '#pickup option[value=tlv_noafter]': 'Трансфер из Тель-Авива — уезжаем до афтепати',
    '#pickup option[value=rhv_after]': 'Трансфер из Реховота — остаёмся на афтепати',
    '#pickup option[value=rhv_noafter]': 'Трансфер из Реховота — уезжаем до афтепати',
