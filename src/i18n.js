...
export const LABELS = {
  en: {
    ...
    '[data-pk=time-q]': 'Staying for the after-party?',
    '[data-pk=ret-after]': 'Staying',
    '[data-pk=ret-before]': 'Not staying',
    '[data-pk=ret-note]': '* Not staying — departure around <span class="t">00:00</span>',
  ...
  ru: {
    ...
    '[data-pk=time-q]': 'Остаётесь до конца?',
    '[data-pk=ret-after]': 'Остаёмся',
    '[data-pk=ret-before]': 'Не остаёмся',
    '[data-pk=ret-note]': '* Не остаёмся — около <span class="t">00:00</span>',
