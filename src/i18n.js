...
export const LABELS = {
  en: {
    ...
    '.pickup-q': 'Which shuttle would you like?',
    '[data-pk=city-none]': 'None needed',
    '[data-pk=city-tlv]': 'From Tel Aviv',
    '[data-pk=city-rhv]': 'From Rehovot',
    '[data-pk=leg-to]': 'We need a ride to the wedding',
    '[data-pk=ret-q]': 'And the ride back?',
    '[data-pk=ret-none]': 'No return',
  ...
  ru: {
    ...
    '.pickup-q': 'Какой трансфер вам нужен?',
    '[data-pk=city-none]': 'Не нужен',
    '[data-pk=city-tlv]': 'Из Тель-Авива',
    '[data-pk=city-rhv]': 'Из Реховота',
    '[data-pk=leg-to]': 'Нужен трансфер на свадьбу (туда)',
    '[data-pk=ret-q]': 'А обратно?',
    '[data-pk=ret-none]': 'Без обратного',
